...
class Navision extends Component
{
    ...
    public function Invoker($credentials, $soapWsdl, $Entry, $wsdlMethod)
    {
...
//RBSS Create customer
    ...
    private function createClient($credentials, $soapWsdl)
    {
        ...
        try {
            ...
            stream_wrapper_register('http', '\\backend\\library\\NTLMStream') or die("Failed to register protocol");
